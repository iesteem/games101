...
public:
    ...
    */
    ...
    void setNormals(const std::array<Vector3f, 3>& normals);//将形参值normals“赋值”给数据成员normal
    void setColors(const std::array<Vector3f, 3>& colors);//将形参值colors“赋值”给数据成员color
